...
var Plane = function (_a) {
    var _b = _a.color, color = _b === void 0 ? 'green' : _b, _c = _a.secondaryColor, secondaryColor = _c === void 0 ? 'blue' : _c, _d = _a.arialLabel, arialLabel = _d === void 0 ? 'plane-loading' : _d, wrapperStyle = _a.wrapperStyle, wrapperClass = _a.wrapperClass, _e = _a.visible, visible = _e === void 0 ? true : _e;
    return (react_1.default.createElement("div", { style: __assign(__assign({}, getDefaultStyle(visible)), wrapperStyle), className: wrapperClass, "data-testid": "plane-loading" },
        react_1.default.createElement("svg", { className: "react-spinner-loader-svg-calLoader", xmlns: "http://www.w3.org/2000/svg", width: "230", height: "230", "aria-label": arialLabel, "data-testid": "plane-svg" },
