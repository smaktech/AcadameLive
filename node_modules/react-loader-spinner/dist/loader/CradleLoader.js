...
require("./css/CradleLoader.css");
var getDefaultStyle = function (visible) { return ({
    display: visible ? 'flex' : 'none'
}); };
var CradleLoader = function (_a) {
    var _b = _a.arialLabel, arialLabel = _b === void 0 ? 'cradle-loading' : _b, wrapperStyle = _a.wrapperStyle, wrapperClass = _a.wrapperClass, _c = _a.visible, visible = _c === void 0 ? true : _c;
    return (react_1.default.createElement("div", { "aria-label": arialLabel, role: "presentation", style: __assign(__assign({}, getDefaultStyle(visible)), wrapperStyle), className: "container ".concat(wrapperClass), "data-testid": "cradle-loading" },
